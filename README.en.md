...
| **Workspace drift audit** | `watchdog.js` checks schema, QMD, registry, and heartbeat-state without applying fixes |
...
| `meta-domain` | Vertical access | Manager contour: selected QMD collections from lower workspaces |
