...
For installation, multi-workspace configuration, troubleshooting, and
per-hook enable/disable, see **[references/setup.md](./references/setup.md)**
(the Hooks section covers `install-hooks.js`, `--hooks-dir`, the bun
build step, and why `--link` is not the default on OpenClaw 2026.6.6).
