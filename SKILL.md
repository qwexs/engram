...
РџР°С‚С‚РµСЂРЅ РґР»СЏ СЃСѓР±Р°РіРµРЅС‚РѕРІ СЃ `cleanup: "delete"` Рё РґРѕР»РіРѕСЃСЂРѕС‡РЅРѕР№ РїР°РјСЏС‚СЊСЋ С‡РµСЂРµР· РґРѕРјРµРЅС‹.

### Quick Start

```bash
# РЎРѕР·РґР°С‚СЊ РґРѕРјРµРЅ
bun skills/engram/scripts/add-domain.js --domain monitoring --description "РњРѕРЅРёС‚РѕСЂРёРЅРі СЃРµСЂРІРµСЂР°"

# РќР°СЃС‚СЂРѕРёС‚СЊ РїСЂР°РІРёР»Р° РІ decisions.md
# Р—Р°РїСѓСЃС‚РёС‚СЊ СЃСѓР±Р°РіРµРЅС‚ СЃ РїСЂРѕРјРїС‚РѕРј РёР· templates/spawn-prompt.md
```

### РЎС‚СЂСѓРєС‚СѓСЂР° РґРѕРјРµРЅР°

```
memory/domains/{domain}/
в”њв”Ђв”Ђ decisions.md    # РџСЂР°РІРёР»Р° (read-only РґР»СЏ СЃСѓР±Р°РіРµРЅС‚Р°)
в”њв”Ђв”Ђ status.md       # РўРµРєСѓС‰РµРµ СЃРѕСЃС‚РѕСЏРЅРёРµ (РїРёС€РµС‚ СЃСѓР±Р°РіРµРЅС‚)
в”њв”Ђв”Ђ changelog.md    # Append-only Р»РѕРі (РїРёС€РµС‚ СЃСѓР±Р°РіРµРЅС‚)
в”њв”Ђв”Ђ archives/       # Р РѕС‚Р°С†РёСЏ changelog
в””в”Ђв”Ђ README.md
```

### РџСЂР°РІРёР»Р°

1. **РћРґРёРЅ РґРѕРјРµРЅ = РѕРґРёРЅ Р°РєС‚РёРІРЅС‹Р№ СЃСѓР±Р°РіРµРЅС‚** РІ Р»СЋР±РѕР№ РјРѕРјРµРЅС‚ РІСЂРµРјРµРЅРё
2. `decisions.md` вЂ” read-only РґР»СЏ СЃСѓР±Р°РіРµРЅС‚РѕРІ; РёР·РјРµРЅРµРЅРёСЏ С‡РµСЂРµР· PROPOSAL РІ changelog
3. РЎСѓР±Р°РіРµРЅС‚ РќР• РїРёС€РµС‚ РІ daily notes РёР»Рё life/
4. QMD: РѕРґРЅР° РєРѕР»Р»РµРєС†РёСЏ `domains` РЅР° РІСЃРµ РґРѕРјРµРЅС‹
5. Heartbeat: review PROPOSAL, СЂРѕС‚Р°С†РёСЏ changelog, РѕРїС†РёРѕРЅР°Р»СЊРЅРѕ KG extraction
...
sessions_spawn({
  ...
  model: "sonnet",
  cleanup: "delete",
  prompt: `## РљРѕРЅС‚РµРєСЃС‚
РўС‹ СЃСѓР±Р°РіРµРЅС‚ РґРѕРјРµРЅР° monitoring.
РўРІРѕСЏ memory: memory/domains/monitoring/
РџСЂРѕС‡РёС‚Р°Р№ decisions.md, РІС‹РїРѕР»РЅРё Р·Р°РґР°С‡Сѓ, РѕР±РЅРѕРІРё status.md Рё changelog.md.`
})
```

РџРѕР»РЅС‹Р№ С€Р°Р±Р»РѕРЅ РїСЂРѕРјРїС‚Р°: `templates/spawn-prompt.md`
РџРѕРґСЂРѕР±РЅР°СЏ РґРѕРєСѓРјРµРЅС‚Р°С†РёСЏ: [references/subagent-memory.md](references/subagent-memory.md)
