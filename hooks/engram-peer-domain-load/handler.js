...
var handler = async (event) => {
  ...
  console.log(`[engram-peer-domain-load] Injected domain context + agents for "${domainName}" → ${sessionKind} ${absChatId} via bootstrap (hash ${contentHash}, agents ${agents.source}, ${Buffer.byteLength(payload, "utf-8")} bytes)`);
};
