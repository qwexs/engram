...
3. Per-label default in `SUBAGENT_MODEL_DEFAULTS` (resolved from `engram.json → models.default`)
4. Generic fallback: `engram.json → models.subagents_default`, then OSS fallback
